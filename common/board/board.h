...
#define USE_IRC_AS_ROOT_CLOCK

#define BOARD_LED_CNT 3
#define BOARD_KEY_CNT 2
...
#ifdef  _BOARD_C_
static const uint8_t ledBits[BOARD_LED_CNT] = {12, 16, 27};
static const uint8_t cs_keyBits[BOARD_KEY_CNT] = {12, 4};
static const uint8_t cs_keyIoConNdce[BOARD_KEY_CNT] = {IOCON_PIO12, IOCON_PIO4};
#endif
